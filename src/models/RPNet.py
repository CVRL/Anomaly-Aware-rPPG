...
class RPNet(nn.Module):
    def __init__(self, input_channels=3, drop_p=0.2, t_kern=5, padding_mode='replicate'):
        '''
        ...
        t_pad =  (t_kern//2, 1, 1)
        t_pad1 = ((t_kern//2)*2, 1, 1)
        t_pad2 = ((t_kern//2)*4, 1, 1)
        t_pad3 = ((t_kern//2)*8, 1, 1)
        ...
        self.conv5 = nn.Conv3d(in_channels=64, out_channels=64, kernel_size=(t_kern,3,3), dilation=(2,1,1), padding=t_pad1, padding_mode=padding_mode)
        ...
        self.conv7 = nn.Conv3d(in_channels=64, out_channels=64, kernel_size=(t_kern,3,3), dilation=(4,1,1), padding=t_pad2, padding_mode=padding_mode)
        ...
        self.conv9 = nn.Conv3d(in_channels=64, out_channels=64, kernel_size=(t_kern,3,3), dilation=(8,1,1), padding=t_pad3, padding_mode=padding_mode)
